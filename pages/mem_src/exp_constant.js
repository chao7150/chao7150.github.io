...
const actions = {
  ...
  startAnswer: () => state => ({ ...state, readonly: "" }),
  ...
  submitConfiguration: () => state => {
    const conf = {
      min: document.getElementById("min").value,
      max: document.getElementById("max").value,
      trialsPerDifficulty: document.getElementById("trialsPerDifficulty").value
    }
    console.log(conf)
    return {...state, setDifficultyPhase: false, configuration: conf}
  }
}
...
const view = (state, actions) => (
  ...
  h("div", {}, [
    h("main", { class: "center" }, [
      ...
      h("p", {}, ["各桁ごとに", h("input", {id: "trialsPerDifficulty"}), "試行ずつ"]),
      h("p", {}, [
